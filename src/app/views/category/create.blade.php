                ...
                <form action="{{ route('categories.store') }}" method="post">
                  @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" required name="title_en" class="form-control" id="title_en" placeholder="Enter a title (English)">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" required name="title_bn" class="form-control" id="title_bn" placeholder="Enter a title (Bengali)">
